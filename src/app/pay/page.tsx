...
export const metadata: Metadata = {
  ...
  description: "Pay for your Gulf website. Wise (AED/USD), PayPal Business, or card link. 48h delivery, transparent remote.",
};
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8 space-y-6">
      <div>
        ...
        <p className="mt-2 text-zinc-600">Ahmedabad → Gulf. Pick your tier, pay via Wise/PayPal/card, we ship in 48h. Invoice within 1 hour.</p>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-4">
        ...
        <div className="rounded-2xl border border-dashed border-zinc-300 p-5 bg-white">
          ...
          <a href="https://wa.me/919999999999?text=Hi%20Erowan%20-%20need%20custom%20quote%20for%20my%20Gulf%20site" target="_blank" rel="noopener noreferrer" className="mt-4 inline-flex px-4 py-2 rounded-full border border-zinc-300 text-sm w-full justify-center">WhatsApp Quote</a>
        </div>
      </div>

      <div id="pay" className="rounded-2xl border border-zinc-200 p-6 bg-white space-y-4">
        <h2 className="font-semibold">How to pay (Gulf — AED/USD)</h2>
        <div className="grid md:grid-cols-3 gap-3 text-sm">
          <div className="rounded-xl bg-emerald-50 border border-emerald-200 p-4">
            <div className="font-medium">Wise Business — Recommended</div>
            <div className="text-zinc-600 mt-1">Lowest fees, AED/USD → INR. Send to <code className="bg-white px-1 py-0.5 rounded border">erowan@wise.com</code> (replace with your Wise email). Add your business name in note.</div>
          ...
          <div className="rounded-xl bg-blue-50 border border-blue-200 p-4">
            ...
            <div className="text-zinc-600 mt-1">Trusted in Gulf, higher fees (~4.4%). PayPal.Me link: <code className="bg-white px-1 py-0.5 rounded border">paypal.me/erowan</code> (replace). Invoice sent in $ or AED.</div>
      ...
      <div className="rounded-2xl border border-zinc-200 p-6 bg-white">
        <h2 className="font-semibold">Book 15-min call — Gulf hours</h2>
        <p className="text-sm text-zinc-600">We cover Gulf afternoons = IST evenings. Pick a slot, bot replies instantly, human joins within 6h.</p>
        ...
        <div className="mt-3 flex gap-2">
          <a href="https://wa.me/919999999999?text=Hi%20Erowan%20-%20book%2015-min%20call%20for%20Gulf%20site" target="_blank" rel="noopener noreferrer" className="px-4 py-2 rounded-full bg-emerald-600 text-white text-sm">WhatsApp to book</a>
          <a href="mailto:hello@erowan.com?subject=Book%20call%20-%20Gulf%20site" className="px-4 py-2 rounded-full border border-zinc-300 text-sm">Email us</a>
        </div>
      </div>
