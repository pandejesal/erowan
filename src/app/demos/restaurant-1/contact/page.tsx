export const metadata = {
  title: "Contact — JLT Dubai | Mira Cafe",
  description: "JLT map, 8am–11pm, WhatsApp order.",
...
export default function Page(){
  return (
    <div className="mx-auto max-w-7xl px-6 py-8">
      <h1 className="text-3xl font-serif font-bold">Contact — JLT</h1>
      <div className="mt-6 grid md:grid-cols-2 gap-6">
        <div className="bg-white border rounded-2xl p-6">
          <div className="font-bold">Visit — JLT, Dubai</div>
          <div className="mt-3 rounded-xl bg-zinc-100 border h-40 grid place-items-center text-xs text-zinc-500">Map — JLT Cluster • Open 8am–11pm</div>
          <div className="mt-3 text-sm space-y-1">
            <div>Phone: +919999999999 (WhatsApp order)</div>
            <div>Email: hello@mira-jlt.ae</div>
            <div>Hours: 8am–11pm daily</div>
          </div>
        </div>
