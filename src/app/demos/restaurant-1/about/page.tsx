export const metadata = {
  title: "About — Mira Cafe JLT • No Commission",
  description: "Tap to order beats PDFs. JLT mornings to late nights, no Talabat fees.",
...
export default function Page(){
  return (
    <div className="mx-auto max-w-7xl px-6 py-8">
      <h1 className="text-3xl font-serif font-bold">About — No commission</h1>
      <div className="mt-6 grid md:grid-cols-2 gap-8">
        <div className="bg-white border rounded-2xl p-6">
          <p className="text-sm leading-6 text-zinc-700">Mira Cafe JLT: brunch to late night. We built tap-to-order because PDFs kill orders. WhatsApp checkout beats Talabat fees. 1.2k orders/mo, 15 min avg prep, daily reels that sell.</p>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white border rounded-2xl p-6"><div className="font-bold">Daily reels</div><p className="text-sm text-zinc-600 mt-1">15-sec reels, brunch for 2, link to menu. JLT mornings.</p></div>
        </div>
      </div>
    </div>
  );
