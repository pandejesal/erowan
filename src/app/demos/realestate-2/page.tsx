...
export const metadata = { title: "Harbor Realty — Miami | Demo" };
export default function Page() {
  return (
    <div className="min-h-screen bg-[#FFFCF8]">
      ...
      <header className="sticky top-0 z-20 bg-white/90 backdrop-blur border-b"><div className="mx-auto max-w-7xl px-6 py-3 flex justify-between items-center"><div className="font-serif font-bold">HARBOR <span className="font-normal text-zinc-500">• MIAMI BRICKELL</span></div><a href="https://wa.me/919999999999" className="px-4 py-2 rounded-full bg-zinc-900 text-white text-xs font-bold">GET BROCHURE</a></div></header>
      <section className="mx-auto max-w-7xl px-6 py-8 md:py-12 grid md:grid-cols-2 gap-8 items-center">
        <div>
          <div className="text-xs tracking-widest border px-2 py-1 rounded-full bg-white inline-block">★ 4.9 • BRICKELL • MLS</div>
          ...
          <p className="mt-4 text-[17px] leading-7 text-zinc-600 max-w-[48ch]">Bilingual, agent cards, map + mortgage hook. Leads to WhatsApp/HubSpot free.</p>
          <div className="mt-6 flex gap-3"><a href="https://wa.me/919999999999" className="px-6 py-3 bg-zinc-900 text-white rounded-full text-sm font-bold">Get brochure</a><a href="#listings" className="px-6 py-3 bg-white border rounded-full text-sm font-bold">Listings</a></div>
        </div>
      ...
      <section id="listings" className="mx-auto max-w-7xl px-6 py-8">
        ...
        <div className="mt-4 grid md:grid-cols-3 gap-4">
          {[
            { name: "2BR — Brickell", price: "$450K", img: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=600&q=80&auto=format&fit=crop" },
