...
import { posts } from "@/lib/mocks/realestate2";
export const metadata = { title: "Blog — Harbor Realty", description: "Hills charges, off-plan vs ready.", alternates:{canonical:"https://erowan.com/demos/realestate-2/blog"} };
export default function Page(){
  return (
    <div className="mx-auto max-w-7xl px-6 py-8">
      <h1 className="text-3xl font-serif font-bold">Blog</h1>
      <div className="mt-6 grid md:grid-cols-3 gap-4">{posts.map(p=>(
        <Link key={p.slug} href={`/demos/realestate-2/blog/${p.slug}`} className="bg-white border rounded-2xl overflow-hidden hover:shadow-sm">
