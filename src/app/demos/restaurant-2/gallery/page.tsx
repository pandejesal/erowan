...
import { gallery } from "@/lib/mocks/restaurant2";

export const metadata = {
  title: "Gallery — Al Hadi Grill Soho",
  description: "Soho brunch gallery, 6 images, interior and brunch.",
...
export default function Page(){
  return (
    <div className="mx-auto max-w-7xl px-6 py-8">
      ...
      <p className="text-sm text-zinc-600 mt-2">Soho mornings to late nights.</p>
