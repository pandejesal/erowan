...
import { posts } from "@/lib/mocks/clinic1";

export const metadata = {
  title: "Blog — SmileCare DHCC Dubai",
  description: "Implant heat, braces at 30, DHCC accreditation.",
  alternates: { canonical: "https://erowan.com/demos/clinic-1/blog" },
};
  ...
  return (
    <div className="mx-auto max-w-7xl px-6 py-8">
      ...
      <div className="mt-6 grid md:grid-cols-3 gap-4">
        {posts.map(p=>(
          <Link key={p.slug} href={`/demos/clinic-1/blog/${p.slug}`} className="bg-white border rounded-2xl overflow-hidden hover:shadow-sm">
